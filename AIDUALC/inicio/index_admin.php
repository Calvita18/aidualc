...
<body>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <img src="../imagenes/estilo_romantico_fondo.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      ...
      <img src="../imagenes/estilo_retro_fondo.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <div class="carousel-caption d-none d-md-block">
        <h5 class="text-white">Deslumbra con el estilo del milenio en cada paso que des.</h5>
      ...
      <img src="../imagenes/estilo_rockero2_fondo.jpg" class="d-block w-100" alt="...">
    </div>
  </div>
