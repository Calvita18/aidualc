...
function cargarEventos(evento){//comprobamos que el estado está interecativo (funciona)
    if(document.readyState=="interactive"){
        ...
        document.getElementById("apellido").addEventListener("click",function (){ocultarError("mapellido")}, true);
        document.getElementById("email").addEventListener("click",function (){ocultarError("mcorreo")}, true);
        document.getElementById("contra").addEventListener("click",function (){ocultarError("mcontrasena")}, true);
        document.getElementById("fecha").addEventListener("click",function (){ocultarError("mfecha")}, true);
        document.getElementById("dir").addEventListener("click",function (){ocultarError("mdireccion")}, true);
...
function comprueba(){
    ...
    var telefono= 0;
        ...
        if(document.getElementById("apellido").value==""){
            document.getElementById("mapellido").className="visible";
        }else{
            apellido=1;
        }
        
        if(document.getElementById("email").value==""){
            document.getElementById("mcorreo").innerText="Campo obligatorio";
            document.getElementById("mcorreo").className="visible";
        }else{
            validarCorreo(document.getElementById("email").value)?correo=1:document.getElementById("mcorreo").className="visible"
             document.getElementById("mcorreo").innerText="No cumple con los requisitos";
        ...
        if(document.getElementById("fecha").value==""){
            ...
            document.getElementById("mfecha").className="visible";
             ...
             mayorDe16(document.getElementById("fecha").value)?fecha=1:document.getElementById("mfecha").className="visible"
    ...
    if(document.getElementById("contra").value==""){
        ...
        document.getElementById("mcontrasena").className="visible";
            ...
            switch (validarContrasena(document.getElementById("contra").value)) {
                case "ok":
                    contra=1;
                    break;
                case "longitud":
