        ...
        <div class="col-12 col-md-8 col-lg-6">
            <div class="card">
                <div class="card-header">
                    <img src="./../imagenes/AIDUALC.png" style="width: 150px; border-radius: 50%;" alt="logo">
                </div>
                    ...
                    <form method="post" action="<?=htmlspecialchars($_SERVER['PHP_SELF'])?>" name="formulario" id="formulario">
                        ...
                        <div class="form-group">
                            <label for="contra" class="form-label">Contraseña:
                                ...
                                <input type="password" name="contra" id="contra" minlength="8" placeholder="Obligatorio" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="telf" name="telf" class="form-control" placeholder="Obligatorio">
                        </div>
                        ...
                        <input type="button" value="Registrarse" id="registrar" class="btn btn-primary">
