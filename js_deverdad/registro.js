...
function cargarEventos(evento) {
    //comprobamos que el estado está interecativo (funciona)
    if (document.readyState == "interactive") {
        ...
        document.getElementById("apellido").addEventListener("click", function () {
            ocultarError("mapellido");
        }, true);
        document.getElementById("email").addEventListener("click", function () {
            ocultarError("mcorreo");
        }, true);
        document.getElementById("contra").addEventListener("click", function () {
        ...
        document.getElementById("telf").addEventListener("click", function () {
...
function comprueba() {
    ...
    if (document.getElementById("fecha").value == "") {
        ...
        if (esFuturo(fechaNacimiento)) {
            document.getElementById("mfecha").innerText = "Por favor, introduzca una fecha válida.";
            document.getElementById("mfecha").className = "visible";
...
function validarCorreo(correo) {
    // compruebo la expresión regular y devuelvo si es válido o no
...
function esFuturo(fecha) {
    ...
    //comprobamos si la fecha de entrada está en el futuro
